...
module.exports = cds.service.impl(async function () {
    ...
    */
    ...
    this.on("READ", Risks, async (req, next) => {
        ...
        the risk entity and the business partner entity are in different systems 
        ...
        each business partner This code could be optimized, instead of having n requests for n business partners, 
